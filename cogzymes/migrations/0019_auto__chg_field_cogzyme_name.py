...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cogzymes_cogzyme', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Cogzyme.name'
        db.alter_column(u'cogzymes_cogzyme', 'name', self.gf('django.db.models.fields.TextField')(max_length=2000, unique=True))
