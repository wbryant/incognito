...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reaction_pred.cogzyme'
        db.add_column(u'cogzymes_reaction_pred', 'cogzyme',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cogzymes.Cogzyme'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Reaction_pred.enzyme_type'
        db.alter_column(u'cogzymes_reaction_pred', 'enzyme_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cogzymes.Enzyme_type'], null=True))

    def backwards(self, orm):
        # Deleting field 'Reaction_pred.cogzyme'
        db.delete_column(u'cogzymes_reaction_pred', 'cogzyme_id')


        # Changing field 'Reaction_pred.enzyme_type'
        db.alter_column(u'cogzymes_reaction_pred', 'enzyme_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cogzymes.Enzyme_type']))
