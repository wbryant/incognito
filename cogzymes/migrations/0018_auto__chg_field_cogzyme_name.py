...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cogzymes_cogzyme', 'name', self.gf('django.db.models.fields.TextField')(unique=True, max_length=2000))

    def backwards(self, orm):

        # Changing field 'Cogzyme.name'
        db.alter_column(u'cogzymes_cogzyme', 'name', self.gf('django.db.models.fields.TextField')(unique=True))
    ...
    models = {
        ...
        u'cogzymes.cogzyme': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {'unique': 'True', 'max_length': '2000'})
        },
        u'cogzymes.enzyme': {
            'Meta': {'object_name': 'Enzyme'},
