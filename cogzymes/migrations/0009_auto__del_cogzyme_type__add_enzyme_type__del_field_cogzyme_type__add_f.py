...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Cogzyme_type'
        db.delete_table(u'cogzymes_cogzyme_type')
        ...
        # Deleting field 'Cogzyme.type'
        db.delete_column(u'cogzymes_cogzyme', 'type_id')

        # Adding field 'Enzyme.type'
        db.add_column(u'cogzymes_enzyme', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cogzymes.Enzyme_type']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Cogzyme_type'
        db.create_table(u'cogzymes_cogzyme_type', (
            ('type', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=1000)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'cogzymes', ['Cogzyme_type'])

        # Deleting model 'Enzyme_type'
        db.delete_table(u'cogzymes_enzyme_type')

        # Adding field 'Cogzyme.type'
        db.add_column(u'cogzymes_cogzyme', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cogzymes.Cogzyme_type']),
                      keep_default=False)

        # Deleting field 'Enzyme.type'
        db.delete_column(u'cogzymes_enzyme', 'type_id')
