...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reaction_pred.type'
        db.add_column(u'cogzymes_reaction_pred', 'type',
                      self.gf('django.db.models.fields.CharField')(default='unk', max_length=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Reaction_pred.type'
        db.delete_column(u'cogzymes_reaction_pred', 'type')
    ...
    models = {
        ...
        u'cogzymes.reaction_pred': {
            ...
            'dev_organism': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dev_organism_preds'", 'to': u"orm['cogzymes.Organism']"}),
            ...
            'ref_organism': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ref_organism_preds'", 'to': u"orm['cogzymes.Organism']"}),
