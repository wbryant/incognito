...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reaction_synonym.preferred'
        db.add_column(u'annotation_reaction_synonym', 'preferred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reaction_synonym.preferred'
        db.delete_column(u'annotation_reaction_synonym', 'preferred')
