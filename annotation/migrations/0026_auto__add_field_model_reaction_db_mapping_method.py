...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Model_reaction.db_mapping_method'
        db.add_column(u'annotation_model_reaction', 'db_mapping_method',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Model_reaction.db_mapping_method'
        db.delete_column(u'annotation_model_reaction', 'db_mapping_method')
