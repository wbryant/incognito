...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Reaction_group'
        db.create_table(u'annotation_reaction_group', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'annotation', ['Reaction_group'])

        # Deleting field 'Mapping.model_reaction_mapping'
        db.delete_column(u'annotation_mapping', 'model_reaction_mapping_id')

        # Deleting field 'Mapping.model_reaction'
        db.delete_column(u'annotation_mapping', 'model_reaction_id')

        # Adding field 'Mapping.group'
        db.add_column(u'annotation_mapping', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['annotation.Reaction_group']),
                      keep_default=False)

        # Adding field 'Mapping.reaction'
        db.add_column(u'annotation_mapping', 'reaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='model_reaction_mapped', to=orm['annotation.Model_reaction']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Reaction_group'
        db.delete_table(u'annotation_reaction_group')

        # Adding field 'Mapping.model_reaction_mapping'
        db.add_column(u'annotation_mapping', 'model_reaction_mapping',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['annotation.Model_reaction_map']),
                      keep_default=False)

        # Adding field 'Mapping.model_reaction'
        db.add_column(u'annotation_mapping', 'model_reaction',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='model_reaction_mapped', to=orm['annotation.Model_reaction']),
                      keep_default=False)

        # Deleting field 'Mapping.group'
        db.delete_column(u'annotation_mapping', 'group_id')

        # Deleting field 'Mapping.reaction'
        db.delete_column(u'annotation_mapping', 'reaction_id')
    ...
    models = {
        ...
        u'annotation.mapping': {
            ...
            'reaction': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'model_reaction_mapped'", 'to': u"orm['annotation.Model_reaction']"})
        },
