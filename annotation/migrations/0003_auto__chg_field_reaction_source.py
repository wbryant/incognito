...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reaction.source'
        db.alter_column(u'annotation_reaction', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['annotation.Source']))

    def backwards(self, orm):

        # Changing field 'Reaction.source'
        db.alter_column(u'annotation_reaction', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Source'], null=True))
