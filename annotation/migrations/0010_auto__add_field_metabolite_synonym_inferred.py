...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metabolite_synonym.inferred'
        db.add_column(u'annotation_metabolite_synonym', 'inferred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metabolite_synonym.inferred'
        db.delete_column(u'annotation_metabolite_synonym', 'inferred')
