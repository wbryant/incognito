...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Model_reaction_mapping'
        db.delete_table(u'annotation_model_reaction_mapping')

        # Deleting model 'Model_reaction_to_mapping'
        db.delete_table(u'annotation_model_reaction_to_mapping')

        # Adding model 'Mapping'
        db.create_table(u'annotation_mapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_reaction_mapping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Model_reaction_map'])),
            ('model_reaction', self.gf('django.db.models.fields.related.ForeignKey')(related_name='model_reaction_mapped', to=orm['annotation.Model_reaction'])),
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Method'])),
        ))
        db.send_create_signal(u'annotation', ['Mapping'])

        # Adding model 'Model_reaction_map'
        db.create_table(u'annotation_model_reaction_map', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'annotation', ['Model_reaction_map'])


    def backwards(self, orm):
        # Adding model 'Model_reaction_mapping'
        db.create_table(u'annotation_model_reaction_mapping', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'annotation', ['Model_reaction_mapping'])

        # Adding model 'Model_reaction_to_mapping'
        db.create_table(u'annotation_model_reaction_to_mapping', (
            ('model_reaction_mapping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Model_reaction_mapping'])),
            ('model_reaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Model_reaction'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Method'])),
        ))
        db.send_create_signal(u'annotation', ['Model_reaction_to_mapping'])

        # Deleting model 'Mapping'
        db.delete_table(u'annotation_mapping')

        # Deleting model 'Model_reaction_map'
        db.delete_table(u'annotation_model_reaction_map')
    ...
    models = {
        ...
        u'annotation.mapping': {
            ...
            'model_reaction': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'model_reaction_mapped'", 'to': u"orm['annotation.Model_reaction']"}),
            'model_reaction_mapping': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['annotation.Model_reaction_map']"})
        },
        ...
        u'annotation.model_reaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapping': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': u"orm['annotation.Model_reaction_map']", 'through': u"orm['annotation.Mapping']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        u'annotation.model_reaction_map': {
            'Meta': {'object_name': 'Model_reaction_map'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
