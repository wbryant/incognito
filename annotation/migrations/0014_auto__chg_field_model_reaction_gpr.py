...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Model_reaction.gpr'
        db.alter_column(u'annotation_model_reaction', 'gpr', self.gf('django.db.models.fields.CharField')(max_length=5000))

    def backwards(self, orm):

        # Changing field 'Model_reaction.gpr'
        db.alter_column(u'annotation_model_reaction', 'gpr', self.gf('django.db.models.fields.CharField')(max_length=2000))
