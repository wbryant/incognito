...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metabolite_synonym.preferred'
        db.add_column(u'annotation_metabolite_synonym', 'preferred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metabolite_synonym.preferred'
        db.delete_column(u'annotation_metabolite_synonym', 'preferred')
