...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'annotation_model_reaction_mapping', (
            ...
            ('method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Mapping_method'])),
        ))
    ...
    models = {
        ...
        u'annotation.model_reaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapping': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['annotation.Model_reaction_mapping']", 'null': 'True', 'blank': 'True'}),
        ...
        u'annotation.model_reaction_mapping': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'method': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['annotation.Mapping_method']"}),
