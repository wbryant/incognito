...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Combfunc_prediction'
        db.create_table(u'annotation_combfunc_prediction', (
            ...
            ('combfunc_score', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'annotation', ['Combfunc_prediction'])

        # Adding model 'Combfunc_result'
        db.create_table(u'annotation_combfunc_result', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gene', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Gene'])),
        ...
        db.send_create_signal(u'annotation', ['Combfunc_result'])


    def backwards(self, orm):
        # Deleting model 'Combfunc_prediction'
        db.delete_table(u'annotation_combfunc_prediction')

        # Deleting model 'Combfunc_result'
        db.delete_table(u'annotation_combfunc_result')
