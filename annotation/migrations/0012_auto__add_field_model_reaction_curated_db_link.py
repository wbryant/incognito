...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Model_reaction.curated_db_link'
        db.add_column(u'annotation_model_reaction', 'curated_db_link',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Model_reaction.curated_db_link'
        db.delete_column(u'annotation_model_reaction', 'curated_db_link')
