...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reaction.reversibility_eqbtr'
        db.add_column(u'annotation_reaction', 'reversibility_eqbtr',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reaction.reversibility_eqbtr'
        db.delete_column(u'annotation_reaction', 'reversibility_eqbtr')
    ...
    models = {
        ...
        u'annotation.reaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'reversibility_eqbtr': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['annotation.Source']"})
        },
