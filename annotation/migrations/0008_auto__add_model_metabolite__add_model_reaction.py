...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Model_metabolite'
        db.create_table(u'annotation_model_metabolite', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('compartment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Compartment'])),
            ('db_metabolite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Metabolite'], null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Source'])),
        ))
        db.send_create_signal(u'annotation', ['Model_metabolite'])

        # Adding model 'Model_reaction'
        db.create_table(u'annotation_model_reaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('db_reaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Reaction'], null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotation.Source'])),
            ('gpr', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'annotation', ['Model_reaction'])

        # Adding M2M table for field metabolites on 'Model_reaction'
        m2m_table_name = db.shorten_name(u'annotation_model_reaction_metabolites')
    ...
    def backwards(self, orm):
        # Deleting model 'Model_metabolite'
        db.delete_table(u'annotation_model_metabolite')

        # Deleting model 'Model_reaction'
        db.delete_table(u'annotation_model_reaction')

        # Removing M2M table for field metabolites on 'Model_reaction'
        db.delete_table(db.shorten_name(u'annotation_model_reaction_metabolites'))
    ...
    models = {
        ...
        u'annotation.model_reaction': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metabolites': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['annotation.Model_metabolite']", 'symmetrical': 'False'}),
            'model_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
