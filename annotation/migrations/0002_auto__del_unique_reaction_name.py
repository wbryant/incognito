...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Reaction', fields ['name']
        db.delete_unique(u'annotation_reaction', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Reaction', fields ['name']
        db.create_unique(u'annotation_reaction', ['name'])
