...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.reference_model'
        db.add_column(u'annotation_source', 'reference_model',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.reference_model'
        db.delete_column(u'annotation_source', 'reference_model')
