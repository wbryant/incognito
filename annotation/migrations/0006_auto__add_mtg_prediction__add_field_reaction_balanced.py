...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mtg_prediction'
        db.create_table(u'annotation_mtg_prediction', (
        ...
        db.send_create_signal(u'annotation', ['Mtg_prediction'])

        # Adding field 'Reaction.balanced'
        db.add_column(u'annotation_reaction', 'balanced',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Mtg_prediction'
        db.delete_table(u'annotation_mtg_prediction')

        # Deleting field 'Reaction.balanced'
        db.delete_column(u'annotation_reaction', 'balanced')
