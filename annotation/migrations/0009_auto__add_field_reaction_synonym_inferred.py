...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reaction_synonym.inferred'
        db.add_column(u'annotation_reaction_synonym', 'inferred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reaction_synonym.inferred'
        db.delete_column(u'annotation_reaction_synonym', 'inferred')
