...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'annotation_mapping_method')

        # Adding model 'Method'
        db.create_table(u'annotation_method', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'annotation', ['Method'])
        ...
        # Deleting field 'Model_reaction_mapping.method'
        db.delete_column(u'annotation_model_reaction_mapping', 'method_id')

        # Deleting field 'Model_reaction.mapping'
        db.delete_column(u'annotation_model_reaction', 'mapping_id')


    def backwards(self, orm):
        # Adding model 'Mapping_method'
        db.create_table(u'annotation_mapping_method', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'annotation', ['Mapping_method'])

        # Deleting model 'Method'
        db.delete_table(u'annotation_method')

        # Deleting model 'Model_reaction_to_mapping'
        db.delete_table(u'annotation_model_reaction_to_mapping')

        # Adding field 'Model_reaction_mapping.method'
        db.add_column(u'annotation_model_reaction_mapping', 'method',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['annotation.Mapping_method']),
                      keep_default=False)

        # Adding field 'Model_reaction.mapping'
        db.add_column(u'annotation_model_reaction', 'mapping',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['annotation.Model_reaction_mapping'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'annotation.model_reaction': {
            ...
            'gpr': ('django.db.models.fields.CharField', [], {'max_length': '5000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
