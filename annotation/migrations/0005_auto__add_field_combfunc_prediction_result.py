...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Combfunc_prediction.result'
        db.add_column(u'annotation_combfunc_prediction', 'result',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['annotation.Combfunc_result']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Combfunc_prediction.result'
        db.delete_column(u'annotation_combfunc_prediction', 'result_id')
